    ...
    'seeders' => [
        'attribute' => [
            ...
            'attribute-groups' => [
                ...
                'general'           => 'အထွေထွေ',
                'inventories'       => 'စာရင်းများ',
                'meta-description'  => 'Meta ဖော်ပြချက်',
                'price'             => 'စျေးနှုန်း',
                'settings'          => 'ဆက်တင်များ',
                'shipping'          => 'ကုန်ပစ္စည်းပို့ခြင်း',
            ],
            ...
            'attributes' => [
                ...
                'description'          => 'ဖော်ပြချက်',
                'featured'             => 'Featured',
                'guest-checkout'       => 'ဧည့်သည် ငွေရှင်း',
                'height'               => 'အမြင့်',
                'length'               => 'အရှည်',
                'manage-stock'         => 'Manage Stock',
                'meta-description'     => 'Meta ဖော်ပြချက်',
                'meta-keywords'        => 'Meta သော့ချက်စာလုံးများ',
                'meta-title'           => 'Meta ခေါင်းစဉ်',
                'name'                 => 'အမည်',
                'new'                  => 'အသစ်',
                'price'                => 'စျေးနှုန်း',
                'product-number'       => 'ထုတ်ကုန်နံပါတ်',
                'short-description'    => 'အတိုချုံး ဖော်ပြချက်',
                'size'                 => 'အရွယ်အစား',
                'sku'                  => 'SKU',
                'special-price'        => 'အထူးစျေးနှုန်း',
                'special-price-from'   => 'အထူးစျေးနှုန်း မှ',
                'special-price-to'     => 'အထူးစျေးနှုန်း ',
                'status'               => 'Status',
                'tax-category'         => 'အခွန် အမျိုးအစား',
                'url-key'              => 'URL Key',
                'visible-individually' => 'တစ်ဦးချင်း မြင်',
                'weight'               => 'အလေးချိန်',
                'width'                => 'အကျယ်',
            ],
        ...
        'category' => [
            'categories' => [
                'description' => 'Root အမျိုးအစားဖော်ပြချက်',
                'name'        => 'Root',
            ],
        ],
        ...
        'cms' => [
            'pages' => [
                'about-us' => [
                    'content' => 'ကျွန်ုပ်တို့၏ စာမျက်နှာ အကြောင်းအရာ',
                    'title'   => 'ကျွန်ုပ်တို့၏ အကြောင်းအရာ',
                ],
        ...
        'core' => [
            'channels' => [
                'name'             => 'Default',
                'meta-title'       => 'Heros Clothes',
                'meta-keywords'    => 'Heros Clothes meta keyword',
                'meta-description' => 'Heros Clothes meta description',
            ],
        ...
        'shop' => [
            'theme-customizations' => [
                'all-products' => [
                    'name' => 'ကုန်ပစ္စည်း အားလုံး',

                    'options' => [
                        'title' => 'ကုန်ပစ္စည်း အားလုံး',
                    ],
                ],

                'bold-collections' => [
                    'content' => [
                        'btn-title'   => 'စုစည်းမှုများကိုကြည့်ပါ',
                        'description' => 'ကျွန်ုပ်တို့၏ အသစ်သော ရဲရင့်သော စုစည်းမှုများကို မိတ်ဆက်ပါသည်! သင်၏စတိုင်ကို စိတ်ကူးယဉ်သော ဒီဇိုင်းများနှင့် အရောင်စုံပြောင်ပြောင်များဖြင့် မြှင့်တင်ပါ။ သင်၏ဝတ်စုံကို ပြောင်းလဲပေးမည့် ထင်ရှားသော ပုံစံများနှင့် ရဲရင့်သော အရောင်များကို ရှာဖွေပါ။ ထူးခြားမှုကို လက်ခံရန် ပြင်ဆင်ပါ!',
                        'title'       => 'သင့်အတွက် ကျွန်ုပ်တို့၏ အသစ်သော ရဲရင့်သော စုစည်းမှုများအတွက် ပြင်ဆင်ပါ!',
                    ],
                ...
                'toke-bag-information' => [
                    'content' => [
                        'btn-title'   => 'အသေးစိတ်ကြည့်ရှုရန်',
                        'description' => 'ကျွန်တော်တို့၏ TOTE BAG ကို ပေါ့ပေါ့ပါးပါး ချည်သားဖြင့် ပြုလုပ်ထားပြီး၊ အိတ်အရွယ်အစားမှာ အလျား ၁၃.၅လက်မနှင့် အနံ ၁၄.၅လက်မ ရှိ၍ ဒီဇိုင်း အရွယ်အစားကို အလျား ၁၀လက်မ နှင့် အနံ ၁၀လက်မ အတွင်း ဖန်တီးပြုထားခြင်းဖြစ်ပါသည်။ DTF Sticker ဖြင့် ရိုက်နှိပ်၍ ဖန်တီးထားခြင်းဖြစ်သဖြင့် အရောင် ခိုင်မြဲမှုအတွက် စိတ်ချရပါသည်။ တစ်မူထူးခြားသော ဒီဇိုင်းများ ဖြစ်သဖြင့် ဝယ်ယူသူများအနေဖြင့် စိတ်တိုင်းကျမှာပါ။ ပြီးတော့ အိတ်၏ အရောင်ကာလာမှာ အသားရောင်ဖြစ်ပြီး နေရာမရွေး အသုံးပြုလျှင် သင့်တော်သည့် အိတ်ကောင်းတစ်ခုဖြစ်နေမှာ အသေအချာဖြစ်ပါသည်။',
                        'title'       => 'TOTE BAG အချက်အလက်များ!',
                    ],

                    'name' => 'TOTE BAG အချက်အလက်များ',
                ],

                't-shirt-information' => [
                    'content' => [
                        'btn-title'   => 'အသေးစိတ်ကြည့်ရှုရန်',
                        'description' => 'ကျွန်တော်တို့၏ T-SHIRT ကို ချည်သားဖြင့် ပြုလုပ်ထားပြီး၊ အိတ်အရွယ်အစားမှာ အလျား ၁၃.၅လက်မနှင့် အနံ ၁၄.၅လက်မ ရှိ၍ ဒီဇိုင်း အရွယ်အစားကို အလျား ၁၀လက်မ နှင့် အနံ ၁၀လက်မ အတွင်း ဖန်တီးပြုထားခြင်းဖြစ်ပါသည်။ DTF Sticker ဖြင့် ရိုက်နှိပ်၍ ဖန်တီးထားခြင်းဖြစ်သဖြင့် အရောင် ခိုင်မြဲမှုအတွက် စိတ်ချရပါသည်။ တစ်မူထူးခြားသော ဒီဇိုင်းများ ဖြစ်သဖြင့် ဝယ်ယူသူများအနေဖြင့် စိတ်တိုင်းကျမှာပါ။ ပြီးတော့ အိတ်၏ အရောင်ကာလာမှာ အသားရောင်ဖြစ်ပြီး နေရာမရွေး အသုံးပြုလျှင် သင့်တော်သည့် အိတ်ကောင်းတစ်ခုဖြစ်နေမှာ အသေအချာဖြစ်ပါသည်။',
                        'title'       => 'T-SHIRT အချက်အလက်များ!',
                    ],

                    'name' => 'T-SHIRT အချက်အလက်များ',
                ],
                ...
                'featured-collections' => [
                    ...
                    'options' => [
                        'title' => 'အထူးအသားပေး ထုတ်ကုန်များ',
                    ],
                ],
                ...
                'game-container' => [
                    'content' => [
                        'sub-title-1' => 'ကျွန်ုပ်တို့၏စုစည်းမှုများ',
                        'sub-title-2' => 'ကျွန်ုပ်တို့၏စုစည်းမှုများ',
                        'title'       => 'ကျွန်တော်တို့ရဲ့ ထပ်ဖြည့်စွက်ချက်အသစ်တွေပါတဲ့ ဂိမ်း!',
                    ],
                ...
                'image-carousel' => [
                    ...
                    'sliders' => [
                        'title' => 'အသစ်သောစုစည်းမှုအတွက်ပြင်ဆင်ပါ',
                    ],
                ],
                ...
                'new-products' => [
                    ...
                    'options' => [
                        'title' => 'ကုန်ပစ္စည်းအသစ်များ',
                    ],
                ],

                'offer-information' => [
                    'content' => [
                        'title' => 'သင်၏ ပထမဆုံး အော်ဒါတွင် 30% အထိ လျှော့ဈေး ရယူပါ SHOP NOW',
                    ],
                ...
                'services-content' => [
                    'description' => [
                        'emi-available-info'   => 'အားလုံးသော အဓိက ခရက်ဒစ်ကတ်များတွင် အခမဲ့ EMI ရနိုင်ပါသည်။',
                        'free-shipping-info'   => 'အခမဲ့ပို့ဆောင်မှုကို အားလုံးသောအော်ဒါများတွင် ပျော်မွေ့ပါ',
                        'product-replace-info' => 'အလွယ်တကူထုတ်လုပ်နိုင်သောပစ္စည်းအစားထိုးနိုင်ပါသည်!',
                        'time-support-info'    => 'စကားပြောခြင်းနှင့် အီးမေးလ်မှတစ်ဆင့် 24/7 ထောက်ပံ့မှု',
                    ],

                    'name' => 'Services Content',

                    'title' => [
                        'emi-available'   => 'Emi ရနိုင်ပါသည်',
                        'free-shipping'   => 'အခမဲ့သယ်ယူပို့ဆောင်ရေး',
                        'product-replace' => 'ကုန်ပစ္စည်းအစားထိုး',
                        'time-support'    => '24/7 အထောက်အကူပြုမှု',
                    ],
                ],

                'top-collections' => [
                    'content' => [
                        'sub-title-1' => 'ကျွန်ုပ်တို့၏ စုဆောင်းမှုများ',
                        'sub-title-2' => 'ကျွန်ုပ်တို့၏ စုဆောင်းမှုများ',
                        'sub-title-3' => 'ကျွန်ုပ်တို့၏ စုဆောင်းမှုများ',
                        'sub-title-4' => 'ကျွန်ုပ်တို့၏ စုဆောင်းမှုများ',
                        'sub-title-5' => 'ကျွန်ုပ်တို့၏ စုဆောင်းမှုများ',
                        'sub-title-6' => 'ကျွန်ုပ်တို့၏ စုဆောင်းမှုများ',
                        'title'       => 'ထပ်ဖြည့်စွက်ချက်အသစ်တွေပါတဲ့ ဂိမ်း!',
                    ],
        ...
        'sample-products' => [
            'product-flat' => [
                '1' => [
                    'description'       => 'Arctic Cozy Knit Beanie သည် အေးသောလများအတွင်း နွေးနွေးထွေးထွေး၊ သက်တောင့်သက်သာရှိပြီး စတိုင်ကျနေစေရန်အတွက် သင့်အတွက် သင့်လျော်သောဖြေရှင်းချက်ဖြစ်သည်။ ပျော့ပျောင်းပြီး တာရှည်ခံသော acrylic knit ဖြင့် ဖန်တီးထားသည့် ဤ beanie သည် သက်တောင့်သက်သာရှိပြီး သက်တောင့်သက်သာရှိစေရန် ဒီဇိုင်းထုတ်ထားသည်။ ဂန္ထဝင်ဒီဇိုင်းသည် အမျိုးသားရော အမျိုးသမီးရော စတိုင်အမျိုးမျိုးကို ဖြည့်စွမ်းနိုင်သော စွယ်စုံသုံးဆက်စပ်ပစ္စည်းကို ပေးဆောင်သည်။ မြို့ထဲမှာ ပေါ့ပေါ့ပါးပါး နေ့တစ်နေ့အတွက် အပြင်ထွက်တာပဲဖြစ်ဖြစ်၊ ဒီ beanie က မင်းရဲ့အဖွဲ့အတွက် သက်တောင့်သက်သာနဲ့ နွေးထွေးမှုကို ထပ်လောင်းပေးတယ်။ ပျော့ပျောင်းပြီး လေဝင်လေထွက်ကောင်းသည့် ပစ္စည်းသည် စွန့်စားမှုမရှိဘဲ သက်တောင့်သက်သာရှိနေစေရန် အာမခံပါသည်။ Arctic Cozy Knit Beanie သည် ဆက်စပ်ပစ္စည်းတစ်ခုမျှသာ မဟုတ်ပါ။ အဲဒါက ဆောင်းတွင်းဖက်ရှင်ရဲ့ ဖော်ပြချက်ပါ။ ၎င်း၏ရိုးရှင်းမှုသည် မတူညီသောဝတ်စုံများနှင့် တွဲရလွယ်ကူစေပြီး ၎င်းကို သင်၏ဆောင်းရာသီဗီရိုတွင် အဓိကအဖြစ်ဖြစ်စေသည်။ လက်ဆောင်ပေးရန် သို့မဟုတ် သင့်အတွက် လက်ဆောင်အဖြစ် သင့်တော်သော၊ ဤ beanie သည် မည်သည့်ဆောင်းရာသီဝတ်စုံအတွက်မဆို ထည့်သွင်းစဉ်းစားစရာတစ်ခုဖြစ်သည်။ ၎င်းသည် လုပ်ဆောင်နိုင်စွမ်းထက်ကျော်လွန်ပြီး စွယ်စုံရအသုံးအဆောင်တစ်ခုဖြစ်ပြီး သင့်အသွင်အပြင်တွင် နွေးထွေးမှုနှင့် စတိုင်လ်ကို ပေါင်းထည့်ထားသည်။ Arctic Cozy Knit Beanie ဖြင့် ဆောင်းရာသီ၏ အနှစ်သာရကို ခံယူပါ။ ပေါ့ပေါ့ပါးပါး နေ့တစ်နေ့ကို အပြင်ထွက်ရင်း ပျော်နေတာပဲဖြစ်ဖြစ်၊ ဒီ beanie က သက်တောင့်သက်သာနဲ့ စတိုင်လ်အတွက် သင့်အဖော်ဖြစ်ပါစေ။ နွေးထွေးမှုကို အချိန်မကုန်နိုင်သော ဖက်ရှင်ကျကျ ပေါင်းစပ်ထားသည့် ဤဂန္ထဝင်အသုံးအဆောင်များဖြင့် သင့်ဆောင်းရာသီဗီရိုကို မြှင့်တင်လိုက်ပါ။',
                    'meta-description'  => 'meta ဖော်ပြချက်',
                    'meta-keywords'     => 'meta1, meta2, meta3',
                    'meta-title'        => 'Meta ခေါင်းစဉ်',
                    'name'              => 'Arctic Cozy Knit Unisex Beanie',
                    'short-description' => 'ကျွန်ုပ်တို့၏ Arctic Cozy Knit Beanie ဖြင့် အေးမြသောနေ့ရက်များကို စတိုင်လ်ကျလိုက်ပါ။ နူးညံ့ပြီး တာရှည်ခံသော acrylic ရောစပ်ထားသည့် ဤဂန္ထဝင် beanie သည် နွေးထွေးမှုနှင့် ဘက်စုံသုံးနိုင်မှုကို ပေးစွမ်းသည်။ အမျိုးသားရော အမျိုးသမီးပါ သင့်တော်ပြီး ပေါ့ပေါ့ပါးပါး ဒါမှမဟုတ် အပြင်မှာ ၀တ်ဆင်ဖို့ အကောင်းဆုံး ဆက်စပ်ပစ္စည်းတစ်ခုပါ။ သင်၏ဆောင်းရာသီဗီရိုကို မြှင့်တင်ပါ သို့မဟုတ် ဤမရှိမဖြစ်လိုအပ်သော beanie ဦးထုပ်ဖြင့် အထူးတစ်စုံတစ်ဦးကို လက်ဆောင်ပေးပါ။',
                ],

                '2' => [
                    'description'       => 'Arctic Bliss Winter Scarf သည် ရာသီဥတုအေးသော ဆက်စပ်ပစ္စည်းတစ်ခုထက် ပိုပါသည်။ ဆောင်းရာသီအတွက် နွေးထွေးမှု၊ နှစ်သိမ့်မှုနှင့် စတိုင်လ်ဖော်ပြချက်ဖြစ်သည်။ ဇိမ်ခံ acrylic နှင့် သိုးမွှေး ရောစပ်ထားသည့် ဂရုတစိုက်ဖြင့် ဖန်တီးထားသည့် ဤပဝါသည် အအေးဆုံးအပူချိန်တွင်ပင် သင့်အတွက် သက်တောင့်သက်သာရှိပြီး သက်တောင့်သက်သာရှိစေရန် ဒီဇိုင်းထုတ်ထားသည်။ ပျော့ပျောင်းပြီး ပျော့ပျောင်းသော အသွင်အပြင်သည် အအေးဒဏ်ကို ခံနိုင်ရည်ရှိရုံသာမက သင့်ဆောင်းရာသီ ဗီရိုတွင် ဇိမ်ခံမှုကိုပါ ထပ်လောင်းပေးပါသည်။ Arctic Bliss Winter Scarf ၏ ဒီဇိုင်းသည် စတိုင်ကျပြီး စွယ်စုံရရှိပြီး ဆောင်းရာသီဝတ်စုံအမျိုးမျိုးအတွက် ပြီးပြည့်စုံသော ထပ်လောင်းတစ်ခုဖြစ်သည်။ အထူးအခွင့်အရေးအတွက် ၀တ်စားဆင်ယင်ခြင်း သို့မဟုတ် သင်၏နေ့စဉ်အသွင်အပြင်တွင် ဆန်းသစ်သောအလွှာကို ပေါင်းထည့်သည်ဖြစ်စေ ဤပဝါသည် သင့်စတိုင်လ်ကို အားစိုက်ထုတ်ကာ အားဖြည့်ပေးပါသည်။ ပဝါ၏ပိုရှည်သောအရှည်သည် စိတ်ကြိုက်ပြင်ဆင်နိုင်သောပုံစံရွေးချယ်စရာများကိုပေးသည်။ ထပ်လောင်းနွေးထွေးစေရန်၊ ပေါ့ပေါ့ပါးပါးပုံစံအတွက် ချည်နှောင်ပါ သို့မဟုတ် သင်၏ထူးခြားသောစတိုင်ကိုဖော်ပြရန်အတွက် မတူညီသောကြိုးများဖြင့် စမ်းသပ်ပါ။ ဤဘက်စုံသုံးနိုင်မှုသည် ဆောင်းရာသီအတွက် မရှိမဖြစ်လိုအပ်သော အသုံးအဆောင်တစ်ခုဖြစ်စေသည်။ ပြီးပြည့်စုံသောလက်ဆောင်ကို ရှာနေပါသလား။ Arctic Bliss Winter Scarf သည် အကောင်းဆုံးရွေးချယ်မှုတစ်ခုဖြစ်သည်။ သင်ချစ်ရသူအား အံ့အားသင့်စေသည်ဖြစ်စေ သင့်ကိုယ်သင် ကုသပေးသည်ဖြစ်စေ ဤပဝါသည် ဆောင်းလတစ်လျှောက်လုံး မြတ်နိုးရမည့် အချိန်မကုန်ဘဲ လက်တွေ့ကျသောလက်ဆောင်တစ်ခုဖြစ်သည်။ နွေးထွေးမှုစတိုင်လ်နှင့် ပြီးပြည့်စုံသော သဟဇာတဖြစ်မှုရှိသော Arctic Bliss Winter Scarf ဖြင့် ဆောင်းရာသီကို ခင်တွယ်လိုက်ပါ။ သင့်အားနွေးထွေးစေရုံသာမက သင်၏အေးသောရာသီဥတုတွင် ခေတ်မီဆန်းသစ်သောအထိအတွေ့ကိုထည့်သွင်းပေးသည့် ဤမရှိမဖြစ်လိုအပ်သောအသုံးအဆောင်ပစ္စည်းများဖြင့် သင့်ဆောင်းရာသီဗီရိုကို မြှင့်တင်လိုက်ပါ။',
                    'meta-description'  => 'meta ဖော်ပြချက်',
                    'meta-keywords'     => 'meta1, meta2, meta3',
                    'meta-title'        => 'Meta ခေါင်းစဉ်',
                    'name'              => 'Arctic Bliss Stylish Winter Scarf',
                    'short-description' => 'ကျွန်ုပ်တို့၏ Arctic Bliss Winter Scarf ဖြင့် နွေးထွေးမှုနှင့် စတိုင်လ်၏ ထွေးပွေ့မှုကို ခံစားလိုက်ပါ။ ဇိမ်ခံ acrylic နှင့် သိုးမွှေးပေါင်းစပ်မှုမှ ဖန်တီးထားသည့် ဤဇိမ်ခံပဝါသည် အအေးဆုံးနေ့ရက်များအတွင်း သင့်ကို ပေါ့ပါးနေစေရန် ဒီဇိုင်းထုတ်ထားသည်။ ၎င်း၏ စတိုင်ကျပြီး စွယ်စုံရ ဒီဇိုင်းသည် ပိုရှည်သော အရှည်ဖြင့် ပေါင်းစပ်ကာ စိတ်ကြိုက်ပြင်ဆင်နိုင်သော စတိုင်လ်ရွေးချယ်မှုများကို ပေးဆောင်သည်။ သင်၏ဆောင်းရာသီဗီရိုကို မြှင့်တင်ပါ သို့မဟုတ် ဤမရှိမဖြစ်လိုအပ်သော ဆောင်းရာသီအသုံးအဆောင်ဖြင့် အထူးတစ်စုံတစ်ဦးကို နှစ်သက်သဘောကျပါ။',
                ],
